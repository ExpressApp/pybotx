...
from botx import Bot, BotAccount, HandlerCollector, constants, lifespan_wrapper
...
async def test__iterate_by_sticker_packs__iterate_by_page_succeed(
    ...
    original_sticker_packs_per_page = constants.STICKER_PACKS_PER_PAGE
    constants.STICKER_PACKS_PER_PAGE = 1  # type: ignore
    ...
    constants.STICKER_PACKS_PER_PAGE = original_sticker_packs_per_page  # type: ignore
