...
@respx.mock
@pytest.mark.asyncio
async def test__add_admin_roles__chat_members_not_modifiable_error_raised(
    ...
    async with lifespan_wrapper(built_bot) as bot:
        with pytest.raises(ChatMembersNotModifiableError) as exc:
            await bot.add_admin_roles(bot_id, chat_id, huids=[huid])
...
@respx.mock
@pytest.mark.asyncio
async def test__add_admin_roles__admin_not_changed_error_raised(
    httpx_client: httpx.AsyncClient,
    host: str,
    bot_id: UUID,
    chat_id: UUID,
    ...
    # - Act -
    async with lifespan_wrapper(built_bot) as bot:
        with pytest.raises(AdministratorsNotChangedError) as exc:
            await bot.add_admin_roles(bot_id, chat_id, huids=[huid])
...
@respx.mock
@pytest.mark.asyncio
async def test__add_admin_roles__permission_denied_error_raised(
    httpx_client: httpx.AsyncClient,
    host: str,
    bot_id: UUID,
    chat_id: UUID,
...
@respx.mock
@pytest.mark.asyncio
async def test__add_admin_roles__chat_not_found_error_raised(
    httpx_client: httpx.AsyncClient,
    host: str,
    bot_id: UUID,
    chat_id: UUID,
...
@respx.mock
@pytest.mark.asyncio
async def test__add_admin_roles__succeed(
    httpx_client: httpx.AsyncClient,
    host: str,
    bot_id: UUID,
    chat_id: UUID,
