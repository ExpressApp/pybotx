...
from botx import ChatMention, Mention, MentionTypes, MessageBuilder, UserMention
...
class TestMentions:
    ...
    def test_mention_not_in_message(self) -> None:
        builder = MessageBuilder()
        with pytest.raises(AttributeError):
            builder.message.entities.mentions
