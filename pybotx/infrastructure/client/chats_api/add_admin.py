...
from pybotx.infrastructure.client.exceptions.common import ChatNotFoundError, PermissionDeniedError
...
def bad_request_error_handler(response: HttpResponse) -> NoReturn:
