...
from pybotx.domain.models.chats import ChatLink
from pybotx.domain.models.enums import ChatLinkTypes
...
def server_error_handler(response: HttpResponse) -> NoReturn:
