...
class BotXAPIFileAttachment(UnverifiedPayloadBaseModel):
    file_name: str
    data: str
    ...
    def from_file_attachment(
        cls,
        attachment: Union[IncomingFile, OutgoingFile],
    ) -> "BotXAPIFileAttachment":
        assert attachment._content is not None
        ...
        return cls(
            ...
            data=encode_rfc2397(attachment._content, mimetype),
        )
