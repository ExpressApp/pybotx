...
class MessageBuilder:  # noqa: WPS214
    ...
    def image(
        self,
        content: str = "data:text/plain;base64,",  # noqa: WPS110
        file_name: str = "image.jpg",
    ) -> None:
        """Add image into incoming message.

        Arguments:
            content: image content in botx format.
    ...
    def document(
        ...
        Arguments:
            content: document content in botx format.
            file_name: name of file.
        """
        self.attachments.__root__.append(
            Attachment(
    ...
    def voice(
        ...
        Arguments:
            content: voice content in botx format.
